...
const CSS_URL = 'https://fonts.googleapis.com/css2?family=Be+Vietnam+Pro:ital,wght@0,400;0,500;0,600;0,700;0,800;1,400&family=Space+Grotesk:wght@500;700&display=swap';
...
async function main() {
  ...
  fs.writeFileSync(path.join(targetDir, 'minh_thu_2_vietnam_fonts.css'), out);
  console.log('Vietnamese fonts written:', (out.length / 1024).toFixed(0), 'KB total');
}
