...
const CSS_URL = 'https://fonts.googleapis.com/css2?family=Be+Vietnam+Pro:ital,wght@0,400;0,600;0,700;0,800;1,600&family=Quicksand:wght@600;700&display=swap';
...
async function main() {
  ...
  fs.writeFileSync(path.join(__dirname, '..', 'kirby-fonts.css'), out);
  console.log('kirby-fonts.css written:', (out.length / 1024).toFixed(0), 'KB total');
}
