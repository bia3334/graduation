...
| `guests/nhu-mai.html` | Như Mai — friend since secondary school | **THEME (canonical): Hoàng hôn biển tím + thuyền giấy.** Current build (rebuilt 2026-08-11): fixed full-page twilight backdrop — 8-stop purple sky #0C0517→#2B1447→#7C3A6E→#B0587E→#F0B37E with a star field, half-sunk sun on the horizon, three looping SVG wave layers and a shimmering sun path on purple water; dark glass cards over it; Lora + Manrope. The paper boat is the recurring character (gate, hero, journey, sunset). Cảnh 1 "Chuyến thuyền mười năm": route drawn by stroke-dashoffset, boat sailing it, two buoys 2016 (biết nhau) → 2026 (vẫn giữ liên lạc) ending at a mortarboard — owner corrected the facts 2026-09-13, do not invent milestones. Cảnh 2 "Lá thư trong chai trôi hơi lâu" carries the slow-reply joke ("tại tớ gửi bằng đường biển") with a bottle that never quite lands + "Đẩy một con sóng cho chai trôi" button. Cảnh 3 (wishes) was removed 2026-09-13 at owner request | **Đã đổi thành thiệp SINH NHẬT (2026-09-13): Như Mai không đi dự lễ được nên section thiệp mời bị bỏ; trang cuối là lời chúc sinh nhật (14/09), xưng hô mày–tao theo ý owner; title/gate đổi thành "Một tấm thiệp sinh nhật". Không có ngày giờ lễ trên trang này nữa.** Warm, humorous, friendly voice. Wishes her to live happily with herself, love life, and text back faster. **An earlier attempt was rejected for leaving the theme** (an oat-paper "post office" with a courier pigeon). Purple sunset sea + paper boat are the identity, not decoration. DOB 14/09/2003. |
